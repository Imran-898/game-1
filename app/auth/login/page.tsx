    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <button id="google-login" className="btn-secondary" onClick={handleGoogleLogin}>
          ...
          <button id="guest-login" className="btn-ghost" onClick={handleGuest} style={{ fontSize: '0.875rem' }}>
            Continue as guest
          </button>
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem', color: 'var(--text-muted)' }}>
          No account?{' '}
          <Link href="/auth/signup" style={{ color: 'var(--color-brand-400)', textDecoration: 'none', fontWeight: 600 }}>
            Sign up free
          </Link>
        </p>
      </motion.div>
